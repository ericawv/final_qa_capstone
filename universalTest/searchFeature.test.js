...
//Locate and click on the Menu toggle at the top right corner of the home page 
        await driver.findElement(By.xpath('/html/body/app-component/header/div/div/div[2]/button[2]/div/div')).click()

        await driver.sleep(5000)
    
//Locate and enter the search criteria 
        let search = await driver.findElement(By.xpath('/html/body/app-component/header/nav/div/div[1]/div[1]/div/input')).sendKeys('Spiderman')

        await driver.findElement(By.xpath('/html/body/app-component/header/nav/div/div[1]/div[1]/div/i')).click()
       
//         await driver.findElement(By.xpath('//*[@id="search-results"]/div/div/section/div/article/p[2]/a')).click()

        // await search.sendKeys('Spiderman')
